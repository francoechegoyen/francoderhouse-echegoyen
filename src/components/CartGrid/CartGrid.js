...
export const CartGrid = () => {
  ...
  const itemsToUpdate = dataBase.collection("coleccion1")
  ...
  return<div className={classes.generalContainer}>
            ...
            {itemsCart.map((item) => (
              <TableRow key={item.item.id}>
                <TableCell component="th" scope="row" align="center">
                    <img src={item.item.pictureUrl} className={classes.imgProducto}></img>
                </TableCell>
    ...
    <div className={classes.container}>
      <Button className={classes.botonVaciar} onClick={clear}>Vaciar carrito</Button>
    </div>
